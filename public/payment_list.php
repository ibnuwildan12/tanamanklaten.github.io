    ...
    <div id="page-content">
      ...
      <div class="page section-header text-center">
        <div class="page-title">
          <div class="wrapper"><h1 class="page-width">Payment Transaction</h1></div>
        </div>
      </div>
      <!--End Page Title-->
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
            <form action="#" method="post" class="cart style2">
              <table>
                ...
                <tbody>
                  <?php $query = $mysqli->query("SELECT tbp.*, tbt.no_order FROM tb_pembayaran as tbp JOIN tb_transaksi as tbt ON tbt.id_transaksi=tbp.id_transaksi WHERE tbt.id_user='$_SESSION[id_costumer]'"); ?>
                  ...
                  <?php while ($values = $query->fetch_object()) { ?>
                    <tr class="text-right small--hide cart-price">
                      ...
                      <td class="text-right small--hide cart-price">
                        <span class="money">Rp.<?= number_format($values->total_bayar); ?>;-</span>
                      </td>
                      <td class="text-right small--hide cart-price">
