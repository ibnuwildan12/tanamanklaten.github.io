            ...
            <div class="collection-header">
                <div class="collection-hero">
                    <div class="collection-hero__image"><img class="blur-up lazyload"
                            data-src="../vendor/assets/images/cat-men.jpg" src="../vendor/assets/images/cat-men.jpg"
                            alt="Men" title="Men" /></div>
                    <div class="collection-hero__title-wrapper">
                        <h1 class="collection-hero__title page-width">Shop Product list</h1>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="product-image">
                                            ...
                                            <a id="<?= $value->id_produk; ?>" onclick="getView(this)"
                                                ...
                                                <img class="primary blur-up lazyload"
                                                    data-src="../vendor/product_img/<?= $slide->filename; ?>"
                                                    src="../vendor/product_img/<?= $slide->filename; ?>" alt="image"
                                                    title="product">
                                                <!-- End image -->
                                                <!-- Hover image -->
                                            ...
                                            <div class="button-set">
                                                <a href="" title="Quick View" class="quick-view-popup quick-view"
                                        ...
                                        <div class="product-details text-center">
                                            ...
                                            <div class="product-price">
                                                ...
                                                <span class="old-price">Rp.
                                                    <?= number_format($value->harga_produk); ?></span>
                                                <span class="price">Rp.
                                                    <?= number_format($value->harga_produk-$getDiskon->total_diskon); ?></span>
                                                <?php else: ?>
                                                <span class="price">Rp.
                                                    <?= number_format($value->harga_produk); ?></span>
                                                <?php endif; ?>
