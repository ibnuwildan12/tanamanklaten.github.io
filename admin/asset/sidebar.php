...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="dashboard.php" class="brand-link">
    <img src="../vendor/assets/logo.png" alt="AdminLTE Logo" class="brand-image elevation-3" style="opacity: .8">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="masterDiskon.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Diskon</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="masterGift.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="masterChat.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Chat</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="masterKomentar.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Komentar</p>
              </a>
            </li>
